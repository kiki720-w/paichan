...
test('confirmed hour-tier rules are visible from navigation and order management',()=>{assert.match(source,/工件定额','业务规则','排产结果/);assert.match(source,/当前工时分档规则/);assert.match(source,/重新生成排产后生效/)});
