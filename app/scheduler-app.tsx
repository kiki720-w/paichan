...
export default function SchedulerApp(){
 ...
 return <div className="shell">
  ...
  <main><header><div><p>生产计划中心</p><h1>{tab}</h1></div><div className="header-actions"><button className="import" onClick={refreshData}>↻ 刷新数据</button><label className="import">导入兴企云 / Excel<input type="file" accept=".xlsx,.xls,.csv" onChange={e=>e.target.files?.[0]&&importExcel(e.target.files[0])}/></label><button className="primary" onClick={run}>▶ 自动排产</button></div></header>
